...
inline void polyval128n2(hctr2_context ctx, __m128i *state, uint8_t *blks, size_t blen, __m128i *hash)
{
...
inline void polyval128n2x4(hctr2_context ctx, __m128i *state, uint8_t *blks, size_t blen, __m128i *hash)
{
