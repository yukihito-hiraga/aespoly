...
inline __m128i polyreduce128(aesgcm_context ctx, __m128i x)
{
...
inline __m128i polydot128(aesgcm_context ctx, __m128i a, __m128i b)
{
...
inline __m128i polyval128(aesgcm_context ctx, __m128i state, __m128i *blks, size_t blen)
{
...
inline __m128i polyval128x4(aesgcm_context ctx, __m128i state, uint8_t *blks, size_t blen)
{
	alignas(16) __m128i X = state;
