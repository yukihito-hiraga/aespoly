...
void wrapper_aespolyW(measurement_context measure_ctx)
{
...
int main(int argc, char **argv)
{
	...
	if (argc < 2)
	{
		res = measure(option, wrapper_aespolyW);
		print_cpb("aespolyW", option, res);
		return 0;
	}
	...
	measurement_target target_aespolyW = make_target("aespolyW", wrapper_aespolyW);
